...
- `src/tw_signal_engine/market_data/`: history-window loaders and replay row parsing
- `src/tw_signal_engine/replay/`: market gating, stream merge, and the main replay session
